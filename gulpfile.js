...
function copyToDist(){
  return gulp.src(['./img/**/*', './*.html', './css/**/*', './vendor/**/*'], {base:'.'})
...
// build, move files and create dist
const dist = gulp.series(clean, modules, css, copyToDist);
const watch = gulp.series(dist, gulp.parallel(watchFiles, browserSync));
